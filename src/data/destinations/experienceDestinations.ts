...
export const destinationsExp: expDestinatiosData[] = [
...

  {
    ...
    <b>Leading tour guides in Cusco and the region:</b><br>
    The tour is conducted by premier tour guides of Cusco, carefully selected for their experience and for the "excellent" feedback we receive from passengers. Assigned privately, they offer attentive and continuous service, explanations tailored to each traveler, and constant monitoring for any signs of fatigue or altitude sickness.<br><br>

    <b>Greater comfort in transportation:</b><br>
    Transportation is in comfortable private vehicles with spacious seats and ample legroom, ideal for a long and demanding journey.<br><br>

    <b>Time to Enjoy and Photograph at Your Leisure:</b><br>
    The private tour allows you to have the time you need to walk, relax, peacefully enjoy the scenery, and take photographs without the pressure of having to follow a group.<br><br>

    <b>Gastronomy: The Best in Route:</b><br>
